   ...
   {\tiny
    \begin{tabular}{cccccccc} 
      \hline 
       ...
       Phoenix & 01/10/2015 & 30/09/2019 & 3 632 486 & 3 632 486 & phoenix-project.eu & @Phoenix\textunderscore FET & \\
...
\afterpage{
 ...
 \thispagestyle{empty} %empty page style
   ...
   \caption{FET projects launched within the Horizon 2020 funding programme as of 15 July 2017. Total and EU funds are expressed in Euro. The links to the websites and Twitter and Facebook accounts were searched for by the author. The search may have missed some of the existing channels, see section \ref{Search_for_channels}. Thus, the information in the table could be incomplete.} \label{Complete_list}
   \end{adjustwidth} 
   \end{table}
   \end{landscape}
 \clearpage
...
%\centering
   ...
   \caption{ResearchGate accounts activated by the FET projects funded within the Horizon 2020 programme as of 15 July 2017. The accounts were searched for by the author. The search may have missed some of the existing profiles, see section \ref{Search_for_channels}. Thus, the information in the table could be incomplete.} \label{ResearchGate_accounts}
   \end{adjustwidth} 
   \end{table}
   \end{landscape}
 \clearpage
